          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="pt-12 sm:pt-14 lg:pt-16 text-center">
              <Link
                ...
                className="inline-block bg-soft-pink text-black px-5 sm:px-6 py-2 sm:py-2.5 rounded-full font-semibold uppercase tracking-wider hover:opacity-90 transition-opacity duration-300 text-xs sm:text-sm text-center min-h-[36px] flex items-center justify-center"
              >
                Sign Up
              </Link>
            </div>
