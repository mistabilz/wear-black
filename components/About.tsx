...
export default function About() {
  ...
  return (
    <section id="about" className="w-full bg-black text-white overflow-hidden scroll-mt-[72px]">
      <div className="min-h-screen flex items-center justify-start py-12 sm:py-16 md:py-20 lg:py-24 xl:py-32">
        <div className="w-full px-4 sm:px-6 lg:px-8 xl:px-12 max-w-7xl">
          <div className="max-w-4xl">
            ...
            <div className="pt-8 sm:pt-10 md:pt-12 lg:pt-14 text-left">
              <Link
